...
<div class="py-3 px-4 text-center bg-secondary text-white tracking-wider">
    Designed & Developed with <span style="display: inline-block; animation:  heartbeat .5s infinite ease; ">❤️</span> by <a class=" hover:underline" href="https://outofboxdesign.com">Outofbox Design</a>
</div>
<style>
    @keyframes heartbeat {
        from {
                ...
                <div>
                    <ul class="text-gray-300 space-y-2 text-sm">
                        ...
                        <li class="flex items-center space-x-2">
                            ...
                            <span><a href="mailto:{{ appSettings('email') }}">{{ appSettings('email') }}</a></span>
                        </li>
                        <li class="flex items-center space-x-2">
                            <span class="text-gray-300">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
